...
# Galaxy S4 Overlays
PRODUCT_PACKAGE_OVERLAYS += vendor/bigfoot/overlay/s4-common

# PA OVERLAY_TARGET
OVERLAY_TARGET := pa_xxhdpi

# Setup device specific product configuration.
PRODUCT_NAME := bigfoot_jfltecan
...
# Copy Bootanimation
PRODUCT_COPY_FILES += \
    vendor/bigfoot/prebuilt/bootanimation/bootanimation_1920_1080.zip:system/media/bootanimation.zip
